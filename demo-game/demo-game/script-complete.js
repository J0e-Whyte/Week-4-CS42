...
function myPreloadCode() {
  ...
  this.load.image( 'sky', 'E:/CS42/demo-game/demo-game/assets/sky.png' ); 
  this.load.image( 'star', 'demo-game/demo-game/assets/star.png' );
  this.load.image( 'dude', 'demo-game/demo-game/assets/1dude.png' );
